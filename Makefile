...
PROJECT_REPO := github.com/SharathChandraB/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_VERSION := 4.111.0
export TERRAFORM_PROVIDER_DOWNLOAD_NAME := terraform-provider-oci
export TERRAFORM_NATIVE_PROVIDER_BINARY := terraform-provider-oci_v4.111.0_x5
...
xpkg.build.provider-sample: do.build.images
